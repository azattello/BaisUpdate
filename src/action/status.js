...
export const getStatus = async () => {
  try {
      const response = await axios.get('https://bais-cargo.kz:3001/api/status/getStatus');
...
export const deleteStatus = async (statusId) => {
  try {
    ...
    const response = await axios.delete(`https://bais-cargo.kz:3001/api/status/deleteStatus/${statusId}`);
